...
class CGameClient : public IGameClient, public CTextureUser
{
	class CStack
	{
	public:
	...
	static void ConDummyinfoCountry(IConsole::IResult *pResult, void *pUserData);
	static void ConDummyinfoSkin(IConsole::IResult *pResult, void *pUserData);
...
public:
	...
	struct CSnapState
	{
		...
		CNetObj_PlayerInfo *m_paPlayerInfos[MAX_CLIENTS];
	...
	struct CClientData
	{
		...
		int m_BlockScore[4][2];
		int m_Blocked;
		int m_BlockLastInteraction;
		int m_BlockType;
		int64 m_BlockInteractionTime;
		int64 m_BlockScoreTime;
	...
	void PredictSnap(CSnapState *pSnap);

	CRenderTools m_RenderTools;

	void OnReset();

	void RenderSecondaryGame(CUIRect Rect, vec2 Center, vec2 CenterShift, float Zoom);
	...
	class CBlockScore *m_pBlockScore;
