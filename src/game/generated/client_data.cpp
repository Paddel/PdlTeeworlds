...
static CDataSound x2528[] = {
	/* x2528[0] */ {  0,  "audio/music_alt.wv", },
};
static CDataSound x2538[] = {
	/* x2538[0] */ {  0,  "audio/menu_button.wv", },
};
static CDataSoundset x9[] = {
	...
	/* x9[41] */ {  "menu_alt",  1,x2528,  -1, },
	/* x9[42] */ {  "menu_button",  1,x2538,  -1, },
};
static CDataImage x14[] = {
	...
	/* x14[13] */ {  "paddel",  "pdl_paddel_anim.png",  -1, },
};
...
static CDataSprite x44[] = {
	...
	/* x44[89] */ {  "abort",  &x28[4],  0,  4,  1,  1, },
	/* x44[90] */ {  "browse_lock",  &x28[3],  0,  0,  1,  1, },
	/* x44[91] */ {  "browse_heart",  &x28[3],  1,  0,  1,  1, },
	/* x44[92] */ {  "browse_epsilon",  &x28[3],  2,  0,  1,  1, },
	/* x44[93] */ {  "browse_unpure",  &x28[3],  3,  0,  1,  1, },
	/* x44[94] */ {  "demobutton_play",  &x28[5],  0,  0,  1,  1, },
	/* x44[95] */ {  "demobutton_pause",  &x28[5],  1,  0,  1,  1, },
	/* x44[96] */ {  "demobutton_stop",  &x28[5],  2,  0,  1,  1, },
	/* x44[97] */ {  "demobutton_slower",  &x28[5],  3,  0,  1,  1, },
	/* x44[98] */ {  "demobutton_faster",  &x28[5],  4,  0,  1,  1, },
	/* x44[99] */ {  "file_demo1",  &x28[6],  0,  0,  1,  1, },
	/* x44[100] */ {  "file_demo2",  &x28[6],  1,  0,  1,  1, },
	/* x44[101] */ {  "file_folder",  &x28[6],  2,  0,  1,  1, },
	/* x44[102] */ {  "file_map1",  &x28[6],  5,  0,  1,  1, },
	/* x44[103] */ {  "file_map2",  &x28[6],  6,  0,  1,  1, },
	/* x44[104] */ {  "guibutton_off",  &x28[7],  0,  0,  4,  4, },
	/* x44[105] */ {  "guibutton_on",  &x28[7],  4,  0,  4,  4, },
	/* x44[106] */ {  "guibutton_hover",  &x28[7],  8,  0,  4,  4, },
	/* x44[107] */ {  "guiicon_mute",  &x28[8],  0,  0,  4,  2, },
	/* x44[108] */ {  "guiicon_friend",  &x28[8],  4,  0,  4,  2, },
	/* x44[109] */ {  "paddel_1",  &x28[9],  0,  0,  4,  4, },
	/* x44[110] */ {  "paddel_2",  &x28[9],  4,  0,  4,  4, },
	/* x44[111] */ {  "paddel_3",  &x28[9],  8,  0,  4,  4, },
	/* x44[112] */ {  "paddel_4",  &x28[9],  0,  4,  4,  4, },
	/* x44[113] */ {  "paddel_5",  &x28[9],  4,  4,  4,  4, },
	/* x44[114] */ {  "paddel_6",  &x28[9],  8,  4,  4,  4, },
	/* x44[115] */ {  "paddel_7",  &x28[9],  0,  8,  4,  4, },
	/* x44[116] */ {  "paddel_8",  &x28[9],  4,  8,  4,  4, },
	/* x44[117] */ {  "paddel_9",  &x28[9],  8,  8,  4,  4, },
};
static CAnimKeyframe x4473[] = {
	/* x4473[0] */ {  0.000000f,  0.000000f,  -4.000000f,  0.000000f, },
};
static CAnimKeyframe x4480[] = {
	/* x4480[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe x4487[] = {
	/* x4487[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe *x4494 = 0;
static CAnimKeyframe *x4518 = 0;
static CAnimKeyframe x4525[] = {
	/* x4525[0] */ {  0.000000f,  -7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4532[] = {
	/* x4532[0] */ {  0.000000f,  7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe *x4539 = 0;
static CAnimKeyframe *x4558 = 0;
static CAnimKeyframe x4565[] = {
	/* x4565[0] */ {  0.000000f,  -3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe x4572[] = {
	/* x4572[0] */ {  0.000000f,  3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x4579 = 0;
static CAnimKeyframe x4598[] = {
	/* x4598[0] */ {  0.000000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4598[1] */ {  0.200000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x4598[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4598[3] */ {  0.600000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4598[4] */ {  0.800000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x4598[5] */ {  1.000000f,  0.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4605[] = {
	/* x4605[0] */ {  0.000000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4605[1] */ {  0.200000f,  -8.000000f,  0.000000f,  0.000000f, },
	/* x4605[2] */ {  0.400000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x4605[3] */ {  0.600000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x4605[4] */ {  0.800000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x4605[5] */ {  1.000000f,  8.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4612[] = {
	/* x4612[0] */ {  0.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x4612[1] */ {  0.200000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x4612[2] */ {  0.400000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x4612[3] */ {  0.600000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4612[4] */ {  0.800000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4612[5] */ {  1.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
};
static CAnimKeyframe *x4619 = 0;
static CAnimKeyframe *x4718 = 0;
static CAnimKeyframe *x4725 = 0;
static CAnimKeyframe *x4732 = 0;
static CAnimKeyframe x4739[] = {
	/* x4739[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.100000f, },
	/* x4739[1] */ {  0.300000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x4739[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.300000f, },
	/* x4739[3] */ {  0.500000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x4739[4] */ {  1.000000f,  0.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x4773 = 0;
static CAnimKeyframe *x4780 = 0;
static CAnimKeyframe *x4787 = 0;
static CAnimKeyframe x4794[] = {
	/* x4794[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.250000f, },
	/* x4794[1] */ {  0.100000f,  0.000000f,  0.000000f,  -0.050000f, },
	/* x4794[2] */ {  0.150000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x4794[3] */ {  0.420000f,  0.000000f,  0.000000f,  0.400000f, },
	/* x4794[4] */ {  0.500000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x4794[5] */ {  1.000000f,  0.000000f,  0.000000f,  -0.250000f, },
};
static CAnimation x75[] = {
	/* x75[0] */ {  "base",  /* x75[0].body */ {  1,x4473, },  /* x75[0].back_foot */ {  1,x4480, },  /* x75[0].front_foot */ {  1,x4487, },  /* x75[0].attach */ {  0,x4494, }, },
	/* x75[1] */ {  "idle",  /* x75[1].body */ {  0,x4518, },  /* x75[1].back_foot */ {  1,x4525, },  /* x75[1].front_foot */ {  1,x4532, },  /* x75[1].attach */ {  0,x4539, }, },
	/* x75[2] */ {  "inair",  /* x75[2].body */ {  0,x4558, },  /* x75[2].back_foot */ {  1,x4565, },  /* x75[2].front_foot */ {  1,x4572, },  /* x75[2].attach */ {  0,x4579, }, },
	/* x75[3] */ {  "walk",  /* x75[3].body */ {  6,x4598, },  /* x75[3].back_foot */ {  6,x4605, },  /* x75[3].front_foot */ {  6,x4612, },  /* x75[3].attach */ {  0,x4619, }, },
	/* x75[4] */ {  "hammer_swing",  /* x75[4].body */ {  0,x4718, },  /* x75[4].back_foot */ {  0,x4725, },  /* x75[4].front_foot */ {  0,x4732, },  /* x75[4].attach */ {  5,x4739, }, },
	/* x75[5] */ {  "ninja_swing",  /* x75[5].body */ {  0,x4773, },  /* x75[5].back_foot */ {  0,x4780, },  /* x75[5].front_foot */ {  0,x4787, },  /* x75[5].attach */ {  6,x4794, }, },
};
static CDataSprite* *x4951 = 0;
static CDataSprite* x5088[] = {
	&x44[29],
	&x44[30],
	&x44[31],
};
static CDataSprite* x5273[] = {
	&x44[35],
	&x44[36],
	&x44[37],
};
static CDataSprite* *x5458 = 0;
static CDataSprite* *x5595 = 0;
static CDataSprite* x5732[] = {
	&x44[52],
	&x44[53],
	&x44[54],
};
static CDataWeaponspec x1887[] = {
	/* x1887[0] */ {  "hammer",  &x44[41],  &x44[42],  &x44[43],  0,x4951,  96,  125,  10,  0,  3,  4.000000f,  -20.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[1] */ {  "gun",  &x44[26],  &x44[27],  &x44[28],  3,x5088,  64,  125,  10,  500,  1,  32.000000f,  4.000000f,  50.000000f,  6.000000f,  5.000000f, },
	/* x1887[2] */ {  "shotgun",  &x44[32],  &x44[33],  &x44[34],  3,x5273,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  70.000000f,  6.000000f,  5.000000f, },
	/* x1887[3] */ {  "grenade",  &x44[38],  &x44[39],  &x44[40],  0,x5458,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[4] */ {  "rifle",  &x44[47],  &x44[48],  &x44[49],  0,x5595,  92,  800,  10,  0,  5,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[5] */ {  "ninja",  &x44[44],  &x44[45],  &x44[46],  3,x5732,  96,  800,  10,  0,  9,  0.000000f,  0.000000f,  40.000000f,  -4.000000f,  5.000000f, },
};
