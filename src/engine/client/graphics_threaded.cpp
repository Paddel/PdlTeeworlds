...
void CGraphics_Threaded::TriangleBegin()
{
...
void CGraphics_Threaded::TriangleEnd()
{
...
void CGraphics_Threaded::TriangleSetRotation(float Angle)
{
	dbg_assert(m_Drawing == DRAWING_TRIANGLE, "called Graphics()->TriangleSetRotation without begin");
	m_Rotation = Angle;
}

void CGraphics_Threaded::TriangleDraw(const CTriangleItem *pArray, int Num)
{
