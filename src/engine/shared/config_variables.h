...
MACRO_CONFIG_INT(Josystick, joystick, 0, 0, 1, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Use joystick")
MACRO_CONFIG_INT(JsSens, js_sens, 450, 5, 100000, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Joystick sensitivity")
