...
container.sounds.Add(SoundSet("menu_alt", ["audio/music_alt.wv"]))
container.sounds.Add(SoundSet("menu_button", ["audio/menu_button.wv"]))
...
image_paddel = Image("paddel", "pdl_paddel_anim.png")
...
container.images.Add(image_paddel)
...
set_emoticons = SpriteSet("emoticons", image_emoticons, 4, 5)
...
set_paddel = SpriteSet("paddel", image_paddel, 12, 12)
...
container.spritesets.Add(set_paddel)
...
container.sprites.Add(Sprite("abort", set_emoticons, 0, 4, 1, 1))
...
container.sprites.Add(Sprite("paddel_1", set_paddel, 0,0,4,4))
container.sprites.Add(Sprite("paddel_2", set_paddel, 4,0,4,4))
container.sprites.Add(Sprite("paddel_3", set_paddel, 8,0,4,4))
container.sprites.Add(Sprite("paddel_4", set_paddel, 0,4,4,4))
container.sprites.Add(Sprite("paddel_5", set_paddel, 4,4,4,4))
container.sprites.Add(Sprite("paddel_6", set_paddel, 8,4,4,4))
container.sprites.Add(Sprite("paddel_7", set_paddel, 0,8,4,4))
container.sprites.Add(Sprite("paddel_8", set_paddel, 4,8,4,4))
container.sprites.Add(Sprite("paddel_9", set_paddel, 8,8,4,4))
